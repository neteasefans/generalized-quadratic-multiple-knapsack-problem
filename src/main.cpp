...
void memetic()
{
	...
	while(generations < Max_generations)
	{
		...
		double f_ts = infeasible_tabu_search(Cur_sol, f_sol);
...
int main(int argc, char *argv[])
{
	if (argc < 2)
	{
		cout << "show usage: MA.exe input_file";
		exit(30);
	}
	...
	srand(seed);
	char out_stat_name[] = "./output_dir_0525/MA_inf_stat_maxgr500.txt";
	char out_sol_name[] = "./output_dir_0525/MA_inf_sol_maxgr500.txt";
	//char out_stat_name[] = "E:\\G-QMKP\\TPS_stat_0507.txt";
	//char out_sol_name[] = "E:\\G-QMKP\\TPS_sol_0507.txt";
	...
	Pert_str = 0.1;
	Time_limit = 3600.0; 	//unused
	Max_generations = 500;

	//parameters for reinforcent learning 
	RL_omega = 0.20;
	RL_alpha = 0.10;
	RL_beta = 0.10;
	RL_gamma = 0.30;
	RL_smoothing_coeff = 0.50;
	RL_proba_threshold = 0.995;
	...
	/*double f_report = 25929.5;
	int type = 1;
	verify_sol_from_file(Cur_sol, f_report, type);*/
