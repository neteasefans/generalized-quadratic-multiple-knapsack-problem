...
{
	if (satisfy_cap_constraints_relocate(item_j, new_knap) && satisfy_nr_constraints_relocate(item_j, old_knap, new_knap))
		return true;
	else
		return false;
}
...
//Complexity: 0(1) time
bool satisfy_cap_constraints_relocate(int item_j, int new_knap)
{
	int class_j_r = Instance.t_jr[item_j];
